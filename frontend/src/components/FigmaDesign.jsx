          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2">
              <img
                ...
                loading="lazy"
              />
              <div className="text-2xl font-bold text-green-700">Diligence</div>
            </div>
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="#pricing" className="text-gray-700 hover:text-green-700 transition">Pricing</a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-4 py-4 space-y-3">
              <a href="#features" className="block text-gray-700 hover:text-green-700">Features</a>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="border-2 border-green-700 text-green-700 px-8 py-4 rounded-lg hover:bg-blue-50 transition text-lg font-semibold">
                Watch Demo
              </button>
            </div>
            <div className="mt-8 flex items-center gap-6">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-300 to-green-700 border-2 border-white"></div>
                ))}
              </div>
              <div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-emerald-300 to-green-700 rounded-2xl p-8 shadow-2xl">
              <img
                src={weeklyview}
